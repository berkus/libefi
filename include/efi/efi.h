...
public:
    static constexpr guid_t guid = {0x91,0x6e,0x57,0x09,0x3f,0x6d,0xd2,0x11,
...
class loaded_image_device_path_protocol_t : public device_path_protocol_t
{
public:
    static constexpr guid_t guid = {0x7e,0x15,0x62,0xbc,0x33,0x3e,0xec,0x4f,
